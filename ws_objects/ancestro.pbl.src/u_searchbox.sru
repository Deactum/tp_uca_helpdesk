...
type variables
boolean ib_realtimesearch = true
...
IF GetTheme() = "Flat Design Dark" THEN
	of_regpicture_search( ".\iconos\png\sle_search_dark.png")
	of_regpicture_remove(".\iconos\png\sle_close_dark.png")
ELSE
	of_regpicture_search( ".\iconos\png\sle_search.png")
	of_regpicture_remove(".\iconos\png\sle_close.png")
END IF
...
integer width = 114
integer height = 100
string picturename = ".\iconos\png\sle_search.png"
...
string picturename = ".\iconos\png\sle_close.png"
boolean focusrectangle = false
end type
