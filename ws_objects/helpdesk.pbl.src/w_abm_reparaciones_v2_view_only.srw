$PBExportHeader$w_abm_reparaciones_v2_view_only.srw
forward
global type w_abm_reparaciones_v2_view_only from w_abm_cyd_base
end type
type gb_repa from groupbox within w_abm_reparaciones_v2_view_only
end type
type gb_comp from groupbox within w_abm_reparaciones_v2_view_only
end type
type tab_detalles from tab within w_abm_reparaciones_v2_view_only
end type
...
type mle_descripcion from multilineedit within w_abm_reparaciones_v2_view_only
end type
type mle_problema from multilineedit within w_abm_reparaciones_v2_view_only
end type
type mle_solucion from multilineedit within w_abm_reparaciones_v2_view_only
end type
type uo_email from uo_envio_email within w_abm_reparaciones_v2_view_only
end type
end forward
...
global w_abm_reparaciones_v2_view_only w_abm_reparaciones_v2_view_only
...
on w_abm_reparaciones_v2_view_only.create
int iCurrent
call super::create
...
on w_abm_reparaciones_v2_view_only.destroy
call super::destroy
...
type cb_2 from w_abm_cyd_base`cb_2 within w_abm_reparaciones_v2_view_only
integer x = 4891
integer y = 2612
end type

type cb_1 from w_abm_cyd_base`cb_1 within w_abm_reparaciones_v2_view_only
integer x = 5289
integer y = 2612
integer taborder = 40
end type

event cb_1::clicked;//Ancestro anulados
cb_2.event clicked()

end event

type dw_detalle from w_abm_cyd_base`dw_detalle within w_abm_reparaciones_v2_view_only
integer x = 3067
integer y = 144
integer width = 2560
integer height = 1112
...
type dw_cabecera from w_abm_cyd_base`dw_cabecera within w_abm_reparaciones_v2_view_only
integer x = 151
integer y = 128
integer width = 2688
integer height = 1144
...
type uo_email from uo_envio_email within w_abm_reparaciones_v2_view_only descriptor "pb_nvo" = "true" 
event create ( )
event destroy ( )
end type
